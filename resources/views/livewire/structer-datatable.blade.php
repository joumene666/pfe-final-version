<div>
    ...
    <div class="my-8 flex items-center">
        <button class="flex items-center relative focus:outline-none border focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 w-72 mr-4">
            ...
            <input wire:model="searchTerm"  type="search" class="block px-2 py-3 text-xs flex-1 relative z-10 rounded-l-md border-gray-200 focus:outline-none focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" placeholder="Chercher" />
        ...
        <tbody class="flex-1 sm:flex-none">
            ...
            >
              ...
              <td class="border-grey-light border hover:bg-gray-100 p-3 truncate">
                <strong>#{{$structer->code_structer}}</strong>
              </td>
              ...
              <td class="border-grey-light border">
                <div class="flex items-center">
                  ...
                  <a href="/gestion-des-structures/{{$structer->id}}/edit"  class="block hover:bg-gray-100 p-3 text-black hover:text-yellow-600 hover:font-medium cursor-pointer focus:outline-none capitalize">
                    Modifier
                  </a>

                  <span>|</span>

                  <button wire:click="showPopUp({{$structer->id}})"
                    type="button"
                    class="hover:bg-gray-100 p-3  text-black hover:text-yellow-600 hover:font-medium cursor-pointer focus:outline-none capitalize"
                  >
                    Supprimer
                  </button>
                  <span>|</span>
                  @endif
                  <a href="/gestion-des-structures/{{$structer->id}}"

    ...
    <form method="POST" wire:submit.prevent="updateStructer">
        ...
        <div class="grid-cols-3 grid gap-4">
            <div class="mb-4 w-64">
                ...
                <span class="block my-3 text-black text-sm">{{$structer->secteur->delegation->gouvernerat->nom}}</span>
            </div>
            <div class="mb-4 w-64">
                <label for="code_structer" class="block mb-1">
                    Délegation
            ...
            <span class="block my-3 text-black text-sm">{{$structer->secteur->delegation->nom}}</span>
        </div>
        <div class="mb-4 w-64">
            <label for="code_structer" class="block mb-1">
                Secteur
